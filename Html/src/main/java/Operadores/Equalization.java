 ...
 * @author camran1234
 */
public class Equalization implements Compare{
            ...
            if(typeL.equalsIgnoreCase("int")){
                int A = Integer.parseInt(left.value());
                    ...
                    if(typeR.equalsIgnoreCase("int")){
                        ...
                        ErrorHandler.semanticErrorsScript.add(new SemanticError("No se puede comparar un entero con un string",B,"Modificar la operacion",
                        left.line, left.column));
                    }else if(typeR.equalsIgnoreCase("boolean")){
                        String B = right.value();
                        ErrorHandler.semanticErrorsScript.add(new SemanticError("No se puede comparar un entero con un booleano",B,"Modificar la operacion",
                        left.line, left.column));
                    }
                ...
                double A = Double.parseDouble(left.value());
                     if(typeR.equalsIgnoreCase("int")){
                        ...
                        String B = right.value();
                        ErrorHandler.semanticErrorsScript.add(new SemanticError("No se puede comparar un decimal con un string",B,"Modificar la operacion",
                        left.line, left.column));
                    }else if(typeR.equalsIgnoreCase("boolean")){
                        String B = right.value();
                        ErrorHandler.semanticErrorsScript.add(new SemanticError("No se puede comparar un decimal con un booleano",B,"Modificar la operacion",
                        left.line, left.column));
                    }
                ...
                char A = left.value().charAt(0);
                     if(typeR.equalsIgnoreCase("int")){
                        ...
                        String B = right.value();
                        ErrorHandler.semanticErrorsScript.add(new SemanticError("No se puede comparar un char con un string",B,"Modificar la operacion",
                        left.line, left.column));
                    }else if(typeR.equalsIgnoreCase("boolean")){
                        String B = right.value();
                        ErrorHandler.semanticErrorsScript.add(new SemanticError("No se puede comparar un char con un boolean",B,"Modificar la operacion",
                        left.line, left.column));
                    }
                ...
                boolean A = Boolean.parseBoolean(left.value());
                     if(typeR.equalsIgnoreCase("int")){
                        String B = right.value();
                        ErrorHandler.semanticErrorsScript.add(new SemanticError("No se puede comparar un "+typeL+" con un "+typeR,B,"Modificar la operacion",
                        left.line, left.column));
                        ...
                        boolean B = Boolean.parseBoolean(right.value());
                        if(A==B){
                            return true;
                        }else{
                            return false;
