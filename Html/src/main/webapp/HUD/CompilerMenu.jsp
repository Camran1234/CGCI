...
<%@page import="com.chtml.table.SymbolV"%>
...
<script>
    function download(  ) {
        ...
        var filename= document.getElementById("name").value +".gcic";
        var type = "txt";
    ...
    %>
                    ...
                    <div class="row">
                        <input type="file" id="file-input" hidden>
                         <label style="background-color:#EEF979; border: 1px solid #ccc; padding-left: 10px; padding-right: 10px; padding-top: 10px;
                                padding-bottom: 10px;" for="file-input" class="open" id="yes">ABRIR</label>
                         
                            <button class="btn btn-info " value="Guardar" onclick="download()" id="yes" >GUARDAR</button>  
                            <textarea style="font-size:18px;" rows="1" id="name"></textarea>
                        </div>
                    <form method="post" action="./Compilador">
                    <textarea id="output" name="code" rows="70" onclick="countLiner()" onkeyup="countLiner()"><%
                              ...
                              %></textarea>
                              <%
                                  String previousPosition = (String)request.getSession().getAttribute("positionA");
                                  request.getSession().removeAttribute("positionA");
                                  if(previousPosition==null){
                                      previousPosition = "Line:0 Column:0";
                                  }
                              %>
...
<% 
    ...
    <script>
        ...
        var currentColumnIndex = textLines[textLines.length-1].length;
            ...
            doucment.getElementById("first").value = "Line: "+currentLineNumber+"\t Column: "+currentColumnIndex;
        }
